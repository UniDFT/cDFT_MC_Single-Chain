...
C      Original Code by J.Wu is for Square-well copolymer *
C      It was modified for LJ copolymer by                *
C                                    Dapeng CAO           *   
C                                    June 15, 2004        *
C**********************************************************
	...
	PARAMETER (ICODE=0,M=4,MA=2,NZ=501,DZ=0.05,F=0.01)
