...
!		
	...
	PARAMETER (M=20,NZ=501,numb=50000)
...
1	  call aver(m,nz,dz,amu,ros,rho,rocm,confg)
...
*   ================= subroutine program =======================
	...
	subroutine aver(m,nz,dz,amu,ros,rho,rocm,confg)
	 parameter(numb=50000)
	 real confg(numb,m,3),ros(m,2*nz-1),rocm(2*nz-1)
	 real ff(2*nz-1),rho(nz),zz(m),cmsum(2*nz-1),cz(m)
